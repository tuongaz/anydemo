...
- **BREAKING:** `CommandContext.canExportDemo` is renamed to `canExportFlow`. Part of the repo-wide scrub of the retired "demo" vocabulary — the artifact is a Flow. Behaviour is unchanged; hosts building a `CommandContext` must rename the field.
