    ...
    nodes: [
      {
        ...
        width: 520,
        height: 44,
        data: { text: 'PR 123 — what the change touches' },
      },
      {
        id: 'lane-api-band',
        type: 'group' as const,
      ...
      },
      {
        ...
        width: 200,
        height: 96,
        data: { name: 'router.ts', backgroundColor: 'green' },
      },
      {
        id: 'el-handler',
        type: 'rectangle' as const,
        ...
        width: 200,
        height: 96,
        data: { name: 'handler.ts', backgroundColor: 'amber' },
      },
      {
        id: 'lf-impact',
        type: 'linkflow' as const,
        position: { x: 40, y: 400 },
        data: { name: 'Impact', target: { project: PROJECT_SLUG, flow: 'impact' } },
      },
    ],
    connectors: [
      {
